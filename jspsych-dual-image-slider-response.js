...
jsPsych.plugins['dual-image-slider-response'] = (function() {
  ...
  plugin.info = {
    name: 'dual-image-slider-response',
    description: '',
    parameters: {
      stimuli: {
      ...
      labels: {
        ...
        pretty_name:'Labels',
        default: ['Very dissimilar', 'Very similar'],
        array: true,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div id="jspsych-image-slider-response-stimulus" style="margin-bottom:50px;"><img src="' + trial.stimuli[0] + '"><img src="' + trial.stimuli[1] + '"></div>';
